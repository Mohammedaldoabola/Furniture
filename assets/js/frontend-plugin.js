jQuery(document).ready(function ($) {
    "use strict";
    function Furniture_google_maps() {
        if ($('.Furniture-google-maps').length <= 0) {
            return;
        }
        $('.Furniture-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    $(document).ready(function () {
        Furniture_google_maps();
    });
    function Furniture_init_menu_toggle() {
        var contain = '.Furniture-nav-toggle';
    ...
    // ----------Furniture_custom_scrollbar-------------------
    function Furniture_custom_scrollbar() {
        $('.Furniture-mini-cart .minicart-items').mCustomScrollbar();
        $('.Furniture-mini-cart .minicart-items').change(function () {
            $('.Furniture-mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function Furniture_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function Furniture_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function Furniture_remove_class_review() {
    ...
    // -----------Furniture_details_thumd--------------------
    function Furniture_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* TOGGLE */
    function Furniture_dropdown() {
        $(document).on('click', '.header-control .close', function () {
            $(this).closest('.Furniture-dropdown').removeClass('open');
        });
        $(document).on('click', function (event) {
            var _target = $(event.target).closest('.Furniture-dropdown');
            var _allparent = $('.Furniture-dropdown');

            if (_target.length > 0) {
                _allparent.not(_target).removeClass('open');
                if (
                    $(event.target).is('[data-Furniture="Furniture-dropdown"]') ||
                    $(event.target).closest('[data-Furniture="Furniture-dropdown"]').length > 0
                ) {
                    _target.toggleClass('open');
                    return false;
                }
            } else {
                $('.Furniture-dropdown').removeClass('open');
            }
        });
    }

    function Furniture_mobile_block() {
    ...
    // =====================slick============================
    function Furniture_init_carousel() {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function Furniture_tab_fade_effect() {
        // effect click
        $(document).on('click', '.Furniture-tabs .tab-link a', function () {
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    function Furniture_countdown() {
        if ($('.Furniture-countdown').length > 0) {
            ...
            $('.Furniture-countdown').each(function () {
    ...
    $(window).resize(function () {
        ...
        Furniture_masonry()
        kt_resizeMegamenu();
        Furniture_remove_class_review();
        Furniture_details_thumd_zoom();
        Furniture_custom_scrollbar();
    });
    $(window).load(function () {
        newletter_popup();
        quickview_popup();
        Furniture_mobile_block();
        Furniture_remove_class_review();
        Furniture_custom_scrollbar()
    });
    Furniture_masonry()
    Furniture_dropdown();
    Furniture_init_carousel();
    Furniture_remove_class_review();
    Furniture_tab_fade_effect();
    Furniture_details_thumd_zoom();
    Furniture_video();
    kt_resizeMegamenu();
    Furniture_custom_scrollbar();
    Furniture_countdown();
    Furniture_init_menu_toggle();
    Furniture_custom_scrollbar_header_nav();
}); 